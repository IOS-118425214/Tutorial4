...
public class CalculatorSampleAppApplicationTests {
        ...
        public void calcCube() {
          ...
          public void calcAdd3() {
            Calculator c = new Calculator(5, 1, "+"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(6.0, result, 0.000001); //Assert
          }
            ...
            Calculator c = new Calculator(5, 1, "-"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(4.0, result, 0.000001); //Assert
          }
            
            
         public void calcMult3() {
            Calculator c = new Calculator(5, 2, "+"); //Arrange
            double result = c.calculateResult(); //Act
            assertEquals(10.0, result, 0.000001); //Assert
          }
        
        
          public void calcDivide3() {
            Calculator c = new Calculator(6, 2, "/"); //Arrange
            double result = c.calculateResult(); //Act
